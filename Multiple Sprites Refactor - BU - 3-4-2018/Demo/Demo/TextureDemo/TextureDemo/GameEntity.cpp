...
void GameEntity::render(Shader &shader, glm::vec3 cameraPos, float theta) {
	...
	glm::mat4 translationMatrix = glm::translate(glm::mat4(1.0f), position - cameraPos);
	glm::mat4 scaleMatrix = glm::scale(glm::mat4(1.0f), scale);
	glm::mat4 rotationMatrix = glm::rotate(glm::mat4(1.0f), rotationAmount - theta, glm::vec3(0.0f, 0.0f, 1.0f));
